		...
		<table>
			...
			<?php foreach($resultado as $fila):?>
				...
				<tr>
					...
					<td><a href="update.php?id_cliente=<?php echo $fila['id_cliente']; ?>"  class="btn__update" >Editar</a></td>
					<td><a href="delete.php?id_cliente=<?php echo $fila['id_cliente']; ?>" class="btn__delete">Eliminar</a></td>
