	...
	if(isset($_GET['id_servicio'])){
		...
		$buscar_id_servicio=$con->prepare('SELECT * FROM servicios WHERE id_servicio=:id_servicio  LIMIT 1');
		$buscar_id_servicio->execute(array(
			':id_servicio'=>$id_servicio 
		));
		$resultado=$buscar_id_servicio->fetch();
	}else{
