	...
	if(isset($_POST['guardar'])){
		...
		if(!empty($descripcion) && !empty($tipo_insumo)  && !empty($destino_insumo) ){
				...
				$consulta_insert=$con->prepare('INSERT INTO insumos(descripcion,tipo_insumo,destino_insumo) VALUES(:descripcion,:tipo_insumo,:destino_insumo)');
...
<body> 
	...
	<div class="contenedor">
		<h2>Nuevos Insumos</h2>
		<form action="" method="post">
			<div class="form-group">
				<input type="text" name="descripcion" placeholder="descripcion" class="input__text"> 
				<input type="text" name="tipo_insumo" placeholder="tipo_insumo" class="input__text">
			</div>
			<div class="form-group">
                <input type="text" name="destino_insumo" placeholder="destino_insumo" class="input__text"> 
